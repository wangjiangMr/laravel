                ...
                <div class="content">
                    ...
                    <form  enctype="multipart/form-data" role="form" onsubmit="return false"  id="form" class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input required="" name="key"  value="{{$list['key']}}" class="form-control"><ul class="parsley-errors-list" id="parsley-id-0525"></ul>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input required="" name="value"  value="{{$list['value']}}" class="form-control"><ul class="parsley-errors-list" id="parsley-id-0525"></ul>
                            </div>
                        </div>
            ...
            $("#bttn").on('click',function(){
                ...
                $.ajax({
                    ...
                    success: function(d) {
                        ...
                        alert(d.msg);
                        window.location.href="{{url('admin/cfg')}}";
