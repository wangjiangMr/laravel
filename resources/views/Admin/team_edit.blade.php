...
@section('body')
    ...
    <div class="page-head">
        <h2><a href="{{ url('admin/team') }}">列表</a> | <a href="{{url('admin/team_edit')}}">添加成员</a></h2>
                ...
                <div class="content">
                    ...
                    <form  enctype="multipart/form-data" role="form" onsubmit="return false"  id="form" class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input required="" name="job_name"  value="{{$list['job_name']}}" class="form-control"><ul class="parsley-errors-list" id="parsley-id-0525"></ul>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <textarea required=""  name="des"  class="form-control" rows="6">{{$list['des']}}</textarea><ul class="parsley-errors-list" id="parsley-id-0525"></ul>
                            </div>
                        </div>
